  ...
  return (
    <div className="mt-20">
        <h2 className="text-3xl sm:text-5xl lg:text-6xl text-center mt-6 tracking-wide">
            Accelerate your
            <span className="bg-gradient-to-r from-red-500 to-red-800 text-transparent bg-clip-text"> coding workflow</span>
        </h2>
        <div className="flex flex-wrap justify-center">
            <div className="p-2 w-full lg:w-1/2 ">
            <img src={Image} alt="codeimg" />
            </div>
            ...
            {checklistItems.map((items, index) =>(
                <div key={index} className="flex mb-12">
                    ...
                    <div>
                        ...
                        <p className="text-stone-500">{items.description}</p>
                    </div>
                </div>
            ))}
